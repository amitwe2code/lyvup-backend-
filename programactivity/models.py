...
class ProgramActivityModel(models.Model):
    ...
    upload_possible = models.CharField(max_length=255,default='no',blank=True,null=True)
    ...
    send_reminder = models.CharField(max_length=255,default='no', blank=True )
    show_in_task = models.CharField(max_length=255,default='no',blank=True)
    add_comment_option = models.CharField(max_length=255,default='no',blank=True)
    indicate_when_completed = models.CharField(max_length=255,default='no',blank=True ,null=True)
